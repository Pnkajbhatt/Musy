...
public class AdminController {
    ...
    // @PostMapping(value = "/artist/applicationsRequest", consumes =
    ...
    // @RequestPart("file") MultipartFile profileImag, HttpServletRequest
    // httpServletRequest) throws IOException {

    // ApiResponse<ApplicationsResDTO> response = ApiResponse.Success(
    // userService.PromoteAsArtist(applicationReqDTO, profileImag), "application has
    // been submited",
    ...
    // public ResponseEntity<ApiResponse<List<ApplicationsResDTO>>>
    // getAllApplications(
    // HttpServletRequest httpServletRequest) {
    // ApiResponse<List<ApplicationsResDTO>> response =
    // ApiResponse.Success(userService.getALLApplication(),
